class Admin::StudentAssigmentsController < AdminController
  ...
  def index
    @student_assigments = StudentAssigment.includes(:student, :course).all
  end
  ...
  def create
    ...
    respond_to do |format|
      if @student_assigment.save
        format.html { redirect_to admin_student_assigments_path, notice: 'Student assigment was successfully created.' }
  ...
  def update
    respond_to do |format|
      if @student_assigment.update(student_assigment_params)
        format.html { redirect_to admin_student_assigments_path, notice: 'Student assigment was successfully updated.' }
  ...
  def destroy
    ...
    respond_to do |format|
      format.html { redirect_to admin_student_assigments_path, notice: 'Student assigment was successfully destroyed.' }
