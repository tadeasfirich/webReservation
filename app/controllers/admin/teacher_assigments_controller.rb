class Admin::TeacherAssigmentsController < AdminController
  ...
  def create
    ...
    respond_to do |format|
      if @teacher_assigment.save
        format.html { redirect_to admin_teacher_assigments_path, notice: 'Teacher assigment was successfully created.' }
  ...
  def update
    respond_to do |format|
      if @teacher_assigment.update(teacher_assigment_params)
        format.html { redirect_to admin_teacher_assigments_path, notice: 'Teacher assigment was successfully updated.' }
  ...
  def destroy
    ...
    respond_to do |format|
      format.html { redirect_to admin_teacher_assigments_path, notice: 'Teacher assigment was successfully destroyed.' }
